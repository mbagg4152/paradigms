...
Lab4*/
/*
The purpose of this program is to read a file line by line, tokenizing at every string of 
alphabetic characters.
If the file name is an actual file, read it.
	While there is something left in the file, read the line into line
		read through the line character by character
			if the character is not a letter, replace it with a space
		tokenize the string based off spaces and print the token
		continue tokenizing until the string is null
	close the file
